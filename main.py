...
model_B.save_weights('./Datasets/TaskB_ContextualizedAttention+LSTM') # save model, change the filename otherwise will overwrite
Load_weight_from_file = False
...
if(Load_weight_from_file):
    print("No training accuracy data because models are loaded from file\n")
